...
class ZebaNaqviCustomEquation_A(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        s = "\ttemp = ((122900.0*x_in**2+177.0)/(22900.0*x_in**2+177.0))**2*((((B+(A-1.0)*x_in**2)/(B+(A+1.0)*x_in**2))+(4.0*x_in**2*(B+A*x_in**2)*(B+(A-1.458)*x_in**2-0.00354))/((B+(A+1.0)*x_in**2)**2*(B+(A+1.458)*x_in**2+0.00354))**2)-((16.0*x_in**2*(cos(2.0*3.14159265358979323846*(A*x_in**2+B)/(x_in**3))**2)*(A*x_in**2+B)*(B+(A-1.0)*x_in**2)*(B+(A-1.458)*x_in**2-0.00354))/(((B+(A+1.0)*x_in**2)**3)*(B+(A+1.458)*x_in**2+0.00354))));\n"
        return s
...
class ZebaNaqviCustomEquation_B(pyeq2.Model_2D_BaseClass.Model_2D_BaseClass):
    ...
    def SpecificCodeCPP(self):
        s = "\ttemp = ((122900.0*x_in**2+177.0)/(22900.0*x_in**2+177.0))**2*(-((16.0*x_in**2*(cos(2*3.14159265358979323846*(A*x_in**2+B)/(x_in**3))**2)*(A*x_in**2+B)*(B+(A-1)*x_in**2)*(B+(A-1.458)*x_in**2-0.00354))/(((B+(A+1)*x_in**2)**3)*(B+(A+1.458)*x_in**2+0.00354))));\n"
        return s
